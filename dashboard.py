...
if fl is not None:
    ...
    os.chdir(r"D:\JihenSkimaDlsiADBD\Streamlit")
...
with col2:
    st.subheader("Region wide Sales")
...
st.subheader("Hierarchical view of Series using TreeMap")
